...
<body>
    ...
    <nav class="navbar navbar-light">
        <a href="<?php echo base_url('index.php/painel/') ?>" ><i class="fa fa-arrow-left back-btn"></i></a>
    ...
    <?php
                ...
                echo heading("Adicionar $nome", 3, 'class="text-uppercase my-5"');
    echo form_open("painel/add/$nome");
               ...
               echo form_label($coluna, $coluna, 'class="text-uppercase"');
